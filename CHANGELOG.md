...
- Token prototype images are now previewable and editable on the sheet. This is compatible with Tokenizer but does not require it. [#3973](https://github.com/dmdorman/hero6e-foundryvtt/issues/3973)
