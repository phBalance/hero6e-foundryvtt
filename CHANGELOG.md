...
- Initial MOVE BY and MOVE THROUGH support.  Velocity assumes token is at rest at beginning and end of phase.  Velocity can be overritten. [#193](https://github.com/dmdorman/hero6e-foundryvtt/issues/193)  
