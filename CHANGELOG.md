...
- Initial NIGHTVISION, INFRAREDPERCEPTION, ULTRASONICPERCEPTION, and ULTRAVIOLETPERCEPTION support. Also if you create a CUSTOMPOWER with the word light in it, you can toggle it on/off like a lantern (QTY = meters of bright vision).
