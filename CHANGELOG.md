...
- You can now select the override key you want to use. It used to be hard coded to be SHIFT. Changed to default to ControlLeft because SHIFT movement was snapless and thus awkward. [#1410](https://github.com/dmdorman/hero6e-foundryvtt/issues/1410)
