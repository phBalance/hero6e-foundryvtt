const { TemplateLayer } = foundry.canvas.layers;

export class HeroSystem6eTemplateLayer extends TemplateLayer {
    ...
    #activatePreviewListeners(preview, initialLayer) {
        ...
        const listeners = (this.#previewListeners = {
            ...
            mousemove: (event) => {
                ...
                const destination = this.getSnappedPoint(localPosition);
    ...
    #deactivatePreviewListeners(initialLayer, event) {
