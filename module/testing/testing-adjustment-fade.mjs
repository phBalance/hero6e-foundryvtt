...
export function registerAdjustmentFadeTests(quench) {
    quench.registerBatch(
        ...
        (context) => {
            ...
            describe("Aid Power Cumulative Stacking & Max Caps", () => {
                let testActor = null;
                ...
                //     // Pull active canvas scene context or fall back to an isolated scratchpad
                //     const activeScene =
                //         game.scenes.active || (await Scene.create({ name: "Quench Test Sandbox", active: true }));

                //     // V14 Mapping Standard: Embedded collections are native Maps; search via .contents array
                //     const existingToken = activeScene.tokens.contents.find((t) => t.name === "Quench Test Target");
                //     if (existingToken) {
                //         await existingToken.delete();
                //     }

                //     // Generate the new synthetic token instance mapped to the active iteration's testActor
                //     const [tokenDoc] = await activeScene.createEmbeddedDocuments("Token", [
                //         {
                //             actorId: testActor.id,
                //             name: "Quench Test Target",
                ...
                //     // Synchronize with afterEach cleanup lifecycle variable to prevent floating ghost tokens
                //     testTokenDoc = tokenDoc;
                ...
                //         Math.floor(actor.system.characteristics.spd.value),
                //         4,
                //         "Sec 12 Check: System failed to handle 5 AP sequential decay floor scaling.",
                //     );
                ...
                //         Math.floor(actor.system.characteristics.spd.value),
                //         3,
                //         "Sec 13 Check: Expected 5e fractional pool floor to drop to 3 SPD.",
                //     );
                ...
                //         Math.floor(actor.system.characteristics.spd.value),
                //         3,
                //         "Sec 14 Check: Expected 5e fractional pool floor to maintain 3 SPD.",
                //     );
                // });
            });
        },
