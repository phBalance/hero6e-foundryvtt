...
export function registerDamageFunctionTests(quench) {
    quench.registerBatch(
        ...
        (context) => {
            ...
            describe("Damage Function Tests", function () {
                ...
                `;
                    ...
                    it("NND Choke Hold description", function () {
                        assert.equal(
                            item.system.description,
                            "1/2 Phase, -2 OCV, +0 DCV, Grab One Limb; 2d6 NND, +4 DC",
                        );
                    });
                });
                ...
                `;
                    ...
                    `;
                        ...
                        before(async function () {
                            ...
                            ebWithAdvAndLimItem = new HeroSystem6eItem(
                                HeroSystem6eItem.itemDataFromXml(ebContent, actor),
                                {
                                    parent: actor,
                                },
                            );
                    ...
                    `;
                        ...
                        before(async function () {
                            ...
                            drainWithLimItem = new HeroSystem6eItem(
                                HeroSystem6eItem.itemDataFromXml(drainContent, actor),
                                {
                                    parent: actor,
                                },
                            );
