...
// export class __HeroSystem6eCombat extends Combat {
//     // static ready() {
//     //     Hooks.on("getCombatTrackerEntryContext", (html, options) => {
//     //         HeroSystem6eCombat.pushMenuOptions(html, options);
//     //     });
...
//         const id = c._id || c.id;
//         const hasSegment = c.actor.hasPhase(this.segmentNumber);
...
//     nextTurn() {
//         const nbC = this.combatants.filter((c) => c.initiative > 0).length;
//         if (this.turn < nbC - 1) {
//             super.nextTurn();
//         } else {
//             this.nextRound();
...
//             }
//             turnData = foundry.utils.deepClone(turnData);
...
// export class _HeroSystem6eCombat extends Combat {
//     constructor(data, context) {
//         super(data, context);
