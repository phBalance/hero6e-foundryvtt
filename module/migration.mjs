...
export async function migrateWorld() {
    ...
    let content = `Version ${game.system.version} of ${game.system.name} has been installed. Be sure to checkout the <a href="https://github.com/dmdorman/hero6e-foundryvtt/blob/main/README.md">README</a> if you are new to the system.  Details about recent changes can be read at <a href="https://github.com/dmdorman/hero6e-foundryvtt/blob/main/CHANGELOG.md">Changelog</a>.<br /><br />If you find any problems, are missing things, or just would like a feature that is lacking, please report these <a href="https://github.com/dmdorman/hero6e-foundryvtt/issues">HERE</a>.<br /><br />There is also a <a href="https://discord.com/channels/609528652878839828/770825017729482772">Discord channel</a> where you can interactively communicate with others using ${game.system.name}.`;
